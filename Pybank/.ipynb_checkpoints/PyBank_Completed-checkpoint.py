 ...
 "cells": [
  {
   ...
   "source": [
    ...
    "\n",
    "#Set path\n",
    "budget_path = os.path.join('..','Pybank','budget_data_copy.csv')\n",
    "\n",
    "#Open and read csv\n",
